<!-- Conference Sections -->
<section id="sections" class="py-16 bg-gray-50">
  <div class="container mx-auto px-4">
    <div class="text-center mb-12">
      <h2 class="text-3xl font-bold text-blue-900 mb-4">THÔNG TIN HỘI NGHỊ</h2>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      @foreach ($conferenceData['sections'] as $section)
        <div class="bg-gradient-to-br from-blue-500 to-blue-700 rounded-lg shadow-lg p-6 text-white">
          <h3 class="text-2xl font-bold tracking-wide mb-4">{{ $section['title'] }}</h3>
          <div class="space-y-3">
            @foreach ($section['items'] as $item)
              <a href="{{ $item['url'] }}"
                class="block bg-white bg-opacity-10 rounded-lg p-3 hover:bg-opacity-25 hover:scale-105 hover:shadow-lg transition-all duration-300 ease-in-out transform">
                <div class="flex items-start">
                  ...
                  <div class="flex-1">
                    <h4 class="text-blue-900 font-medium hover:text-blue-800 transition-colors">{{ $item['title'] }}</h4>
