      ...
      <div class="mb-12">
        ...
        <div class="flex flex-wrap justify-center items-center gap-6 px-4">
          @foreach ($sponsorsByType['diamond'] as $sponsor)
            <div class="group">
              <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-200 hover:border-purple-300 p-4 w-48 h-32">
                <div class="flex items-center justify-center h-full">
                  <img src="{{ asset($sponsor['logo']) }}" alt="{{ $sponsor['name'] }}" class="max-w-full max-h-full object-contain max-h-20">
                </div>
              </div>
            </div>
          @endforeach
            ...
            <div>
              ...
              <div class="flex flex-wrap justify-center items-center gap-6 px-4">
                @foreach ($sponsorsByType['gold'] as $sponsor)
                  <div class="group">
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-200 hover:border-yellow-300 p-4 w-36 h-28">
                      <div class="flex items-center justify-center h-full">
                        <img src="{{ asset($sponsor['logo']) }}" alt="{{ $sponsor['name'] }}" class="max-w-full max-h-full object-contain max-h-16">
                      </div>
                    </div>
                  </div>
                @endforeach
            ...
            <div>
              ...
              <div class="flex flex-wrap justify-center items-center gap-6 px-4">
                @foreach ($sponsorsByType['silver'] as $sponsor)
                  <div class="group">
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-200 hover:border-gray-300 p-4 w-32 h-24">
                      <div class="flex items-center justify-center h-full">
                        <img src="{{ asset($sponsor['logo']) }}" alt="{{ $sponsor['name'] }}" class="max-w-full max-h-full object-contain max-h-14">
                      </div>
                    </div>
                  </div>
                @endforeach
            ...
            <div>
              ...
              <div class="flex flex-wrap justify-center items-end gap-6 px-4">
                @foreach ($sponsorsByType['bronze'] as $sponsor)
                  <div class="group">
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-200 hover:border-orange-300 p-4 w-28 h-20">
                      <div class="flex items-center justify-center h-full">
                        <img src="{{ asset($sponsor['logo']) }}" alt="{{ $sponsor['name'] }}" class="max-w-full max-h-full object-contain max-h-12">
                      </div>
                    </div>
                  </div>
                @endforeach
            ...
            <div>
              ...
              <div class="flex flex-wrap justify-center items-end gap-6 px-4">
                @foreach ($sponsorsByType['copper'] as $sponsor)
                  <div class="group">
                    <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-200 hover:border-green-300 p-4 w-24 h-16">
                      <div class="flex items-end justify-center h-full">
                        <img src="{{ asset($sponsor['logo']) }}" alt="{{ $sponsor['name'] }}" class="max-w-full max-h-full object-contain max-h-10">
                      </div>
                    </div>
                  </div>
                @endforeach
